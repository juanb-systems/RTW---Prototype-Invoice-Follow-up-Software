...
function AttentionCard({
  ...
  return (
    <div className={`rounded-2xl border overflow-hidden transition-all ${
      ...
      {/* ── Expanded items ── */}
      {isOpen && (
        <div className={`border-t px-4 pt-2 pb-3 ${cfg.urgent ? "border-current/20 bg-black/[0.05]" : "border-gray-200 bg-gray-100"}`}>
            ...
            {overdueItems.length > 0 && (
              <div className="rounded-2xl border border-orange-200 bg-orange-50 overflow-hidden">
                ...
                {openKey === "overdue_combined" && (
                  <div className="border-t border-orange-200 bg-black/[0.05] px-4 pt-2 pb-3">
